      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 relative flex flex-col min-w-0 bg-white">
          ...
          <div className="absolute top-6 left-6 z-10 flex gap-3">
            <button className="flex items-center gap-2 px-3 py-2 bg-white border border-slate-100 rounded-lg shadow-sm text-xs font-semibold text-slate-700 hover:bg-slate-50 transition-all">
                 ...
                 <div className="p-4">
                    ...
                    <div className="space-y-1 text-[12px] leading-relaxed">
                      ...
                      <div className="pt-2 mt-2 border-t border-slate-50">
                        ...
                        <p className="text-slate-700 font-semibold mt-1">Connections: 2</p>
                      </div>
                    </div>
                 </div>
               </div>
